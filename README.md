# Beware of those
1. Put each file in the exact location that you find it in starting from your home directory ~; for example you found /rofi inside .config put it in the location ~/.config
